...
```
git clone https://github.com/albertSu123/albertsu123.github.io
```

4) go into the folder with 
```
cd albertsu123.github.io
```
...
If you want to use the form in the Photography page, you'll need to make an account with https://formspree.io/. Then simply update the email in the _config.yml to whatever you used to register.
